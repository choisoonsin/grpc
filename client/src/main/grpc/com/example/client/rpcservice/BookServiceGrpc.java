...
public final class BookServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.example.client.rpcservice.BookProto.Book,
      com.example.client.rpcservice.BookProto.Book> getGetBookMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetBook",
      requestType = com.example.client.rpcservice.BookProto.Book.class,
      responseType = com.example.client.rpcservice.BookProto.Book.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.example.client.rpcservice.BookProto.Book,
      com.example.client.rpcservice.BookProto.Book> getGetBookMethod() {
    io.grpc.MethodDescriptor<com.example.client.rpcservice.BookProto.Book, com.example.client.rpcservice.BookProto.Book> getGetBookMethod;
      ...
      synchronized (BookServiceGrpc.class) {
        if ((getGetBookMethod = BookServiceGrpc.getGetBookMethod) == null) {
          BookServiceGrpc.getGetBookMethod = getGetBookMethod =
              io.grpc.MethodDescriptor.<com.example.client.rpcservice.BookProto.Book, com.example.client.rpcservice.BookProto.Book>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetBook"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.client.rpcservice.BookProto.Book.getDefaultInstance()))
  ...
  public static abstract class BookServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getBook(com.example.client.rpcservice.BookProto.Book request,
        io.grpc.stub.StreamObserver<com.example.client.rpcservice.BookProto.Book> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.example.client.rpcservice.BookProto.Book,
                com.example.client.rpcservice.BookProto.Book>(
  ...
  public static final class BookServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<BookServiceBlockingStub> {
    ...
    /**
     */
    public com.example.client.rpcservice.BookProto.Book getBook(com.example.client.rpcservice.BookProto.Book request) {
  ...
  public static final class BookServiceFutureStub extends io.grpc.stub.AbstractFutureStub<BookServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.example.client.rpcservice.BookProto.Book> getBook(
        com.example.client.rpcservice.BookProto.Book request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_BOOK:
          serviceImpl.getBook((com.example.client.rpcservice.BookProto.Book) request,
              (io.grpc.stub.StreamObserver<com.example.client.rpcservice.BookProto.Book>) responseObserver);
          break;
        default:
  ...
  private static abstract class BookServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.example.client.rpcservice.BookProto.getDescriptor();
    }
